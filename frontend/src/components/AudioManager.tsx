                ...
                <>
                    ...
                    <div className='relative w-full flex justify-center items-center'>
                        <TranscribeButton
                            ...
                            isModelLoaded={props.transcriber.isModelLoaded}
            ...
            content={
                <>
                    ...
                    {props.transcriber.multilingual && (
                        <>
                            <label>Булак тилин тандоо.</label>
                            <select
                            ...
                            >
                                <option value={"transcribe"}>Транскрипцияла</option>
...
function UrlModal(props: {
    ...
    return (
        <Modal
            ...
            content={
                <>
                    {"Жүктөмөкчү болгон аудио файлынын URL дарегин киргизиңиз."}
...
function RecordModal(props: {
    ...
    return (
        <Modal
            ...
            content={
                <>
                    {"Микрофонуңуз менен аудио жазыңыз"}
